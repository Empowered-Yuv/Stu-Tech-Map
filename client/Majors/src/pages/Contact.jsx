    ...
    <ul class="flex flex-wrap items-start gap-8">
        <li class="w-2/5">
            ...
            <p class="mt-2">
                ...
                Choosing a technical field depends on your interests, strengths, and career goals. Research different fields such as computer science, engineering, information technology, etc. Explore their job prospects, required skills, and potential for growth. 
                </p>
            </p>
        </li>
        <li class="w-2/5">
        ...
        <li class="w-2/5">
            ...
            <p class="mt-2">
                <p class="text-base leading-6 text-gray-500">
                Stay updated by following industry blogs, subscribing to relevant newsletters and our website, joining online communities such as Stack Overflow, GitHub, or Reddit, attending conferences, webinars, and tech meetups, and networking with professionals in your field through platforms like LinkedIn.
                </p>
            </p>
        </li>
        <li class="w-2/5">
        ...
        <li class="w-2/5">
            ...
            <p class="mt-2">
                <p class="text-base leading-6 text-gray-500">
                Gain practical experience by working on projects, participating in internships, contributing to open-source projects, and attending hackathons or coding competitions. Build a portfolio showcasing your projects, skills, and achievements, and leverage online platforms like GitHub or LinkedIn to showcase your work to potential employers.
                </p>
            </p>
        </li>
        <li class="w-2/5">
            <p class="text-lg font-medium leading-6 text-gray-900">
            What are the best strategies for networking and advancing my career in the tech industry?
            </p>
            <p class="mt-2">
                <p class="text-base leading-6 text-gray-500">
                Networking is essential in the tech industry. Build genuine relationships, seek mentorship opportunities, and stay updated on industry news and developments to advance your career in the tech industry. Connect with our mentors for genuine guidance.
                </p>
            </p>
        </li>
    </ul>
